...
- [2.1. 模型列表](#21-模型列表)
- [2.2. 对话模型](#22-对话模型)
- [2.2.1. 创建对话请求（OpenAI）](#221-创建对话请求openai)
- [2.2.2. 创建对话请求（Anthropic）](#222-创建对话请求anthropic)
- [2.2.3. 创建对话请求（Google）](#223-创建对话请求google)
- [2.3. 多模态模型](#23-多模态模型)
- [2.3.1. 创建多模态请求（OpenAI）](#231-创建多模态请求openai)
- [2.3.2. 搜索请求示例（OpenAI）](#232-搜索请求示例openai)
- [2.3.2.1. 创建原生模型搜索请求](#2321-创建原生模型搜索请求)
- [2.3.2.2. 创建默认搜索请求](#2322-创建默认搜索请求)
- [2.3.3. 搜索请求示例（Google）](#233-搜索请求示例google)
- [2.3.3.1. 创建原生模型搜索请求](#2331-创建原生模型搜索请求)
- [2.3.3.2. 创建默认搜索请求](#2332-创建默认搜索请求)
- [2.3.4. 创建视频理解请求（Google）](#234-创建视频理解请求google)
- [2.3.5. 创建视频](#235-创建视频)
- [2.3.5.1. 创建视频请求（OpenAI）](#2351-创建视频请求openai)
- [2.3.5.2. 获取视频内容请求（OpenAI）](#2352-获取视频内容请求openai)
