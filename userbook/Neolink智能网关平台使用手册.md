...
- [2.1. 模型列表](#2.1. 模型列表)
- [2.2. 对话模型](#2.2. 对话模型)
- [2.2.1. 创建对话请求（OpenAI）](#2.2.1. 创建对话请求（OpenAI）)
- [2.2.2. 创建对话请求（Anthropic）](#2.2.2. 创建对话请求（Anthropic）)
- [2.2.3. 创建对话请求（Google）](#2.2.3. 创建对话请求（Google）)
- [2.3. 多模态模型](#2.3. 多模态模型)
- [2.3.1. 创建多模态请求（OpenAI）](#2.3.1. 创建多模态请求（OpenAI）)
- [2.3.2. 搜索请求示例（OpenAI）](#2.3.2. 搜索请求示例（OpenAI）)
- [2.3.2.1. 创建原生模型搜索请求](#2.3.2.1. 创建原生模型搜索请求)
- [2.3.2.2. 创建默认搜索请求](#2.3.2.2. 创建默认搜索请求)
- [2.3.3. 搜索请求示例（Google）](#2.3.3. 搜索请求示例（Google）)
- [2.3.3.1. 创建原生模型搜索请求](#2.3.3.1. 创建原生模型搜索请求)
- [2.3.3.2. 创建默认搜索请求](#2.3.3.2. 创建默认搜索请求)
- [2.3.4. 创建视频理解请求（Google）](#2.3.4. 创建视频理解请求（Google）)
- [2.3.5. 创建视频](#2.3.5. 创建视频)
- [2.3.5.1. 创建视频请求（OpenAI）](#2.3.5.1. 创建视频请求（OpenAI）)
- [2.3.5.2. 获取视频内容请求（OpenAI）](#2.3.5.2. 获取视频内容请求（OpenAI）)
